...
def parse_args():
    ...
    parser.add_argument('--weights', dest='caffemodel',
                        help='model to test',
                        default=os.path.join(cwd,'mscnn_caltech_train_2nd_iter_40000.caffemodel')\
                        , type=str)
    ...
    parser.add_argument('--detection', dest='dt_name',  help='model to test', default='one-minus', type=str)
